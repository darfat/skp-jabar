...
def set_cookie_and_redirect(req, redirect_url):
    print "I WANT LOGIN set_cookie_and_redirect........................."
...
<html style="height: 100%%">
    <head>
        ...
        <title>Sistem Penilaian Prestasi Kerja | BKD-Jabar</title>
...
class Home(openerpweb.Controller):
    ...
    def login(self, req, db, login, key):
        print "I want LOgin Pleas ##############################"
        print " SHAHAHAHA ",reqpsdasdsa
